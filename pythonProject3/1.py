...
# Дизайн квадратной формы, я изначально сделал его 4 × 4, потому что наибольшая длина и ширина равны 4, поэтому, когда вы поворачиваете, вы не думаете о том, как повернуть, просто заменяете одно изображение другим
# Фактически, чтобы добиться этой функции, вам нужно только исправить координаты левого верхнего угла.
